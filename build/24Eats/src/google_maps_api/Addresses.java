 ...
 */
public class Addresses extends AsyncTask<Location, Void, String> {
	Context mContext;
	AddressesModifier callback;
	
	public Addresses(Context context){
		super();
	}
	
	public Addresses(Context context,AddressesModifier func) {
		this(context);
		callback = func;
		mContext = context;
	}
